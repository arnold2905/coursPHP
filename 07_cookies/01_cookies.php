...
<body>
    <header class="container-fluid f-header p-2">
        <h1 class="display-4 text-center text-primary text-decoration-underline">CoursPHP - Cookies</h1>
        <p class="lead text-center text-danger text-decoration-underline">Chapitre VII - Cookies</p> 
    </header>
    <!-- fin container fluid  -->
