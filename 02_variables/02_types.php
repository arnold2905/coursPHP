...
<body>
    <header class="container-fluid-bg-light">
        <h1 class="display-4 text-center text-primary text-decoration-underline">CoursPHP - 02 - TYPES DE DONNEES </h1>
        <p class="lead text-center text-danger text-decoration-underline">Les types de données</p>
            ...
            <tbody>
                ...
                <th scope="row">++</th>
                    ...
                    <?php
                        ...
                        echo $var++. " devient après incrémentation $var";
                        echo "</div>";
