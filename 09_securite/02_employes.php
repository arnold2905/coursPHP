...
<html lang="fr">
  ...
  <main>
    <header class="container-fluid f-header p-2">
      <h1 class="display-4 text-center text-primary text-decoration-underline">CoursPHP - Chapitre 09 - 02 employé</h1>
      <p class="lead text-center text-danger text-decoration-underline">les employés de l'entreprise</p>
    </header> 
