...
<head>
    ...
    <title> CoursPHP - Chapitre VI - PDO</title>
...
<body>
    <header class="container-fluid f-header p-2">
        <h1 class="display-4 text-center text-primary text-decoration-underline">CoursPHP - 01 PDO</h1>
        <p class="lead text-center text-danger text-decoration-underline">Chapitre VI - 01_PDO</p> 
    </header>
    <!-- fin container fluid  -->
